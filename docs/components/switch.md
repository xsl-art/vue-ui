...
| active-text | 开启时显示的文本 | `string` | — |
| inactive-text | 关闭时显示的文本 | `string` | — |
| active-value | 开启时的值 | `boolean \| string \| number` | `true` |
| inactive-value | 关闭时的值 | `boolean \| string \| number` | `false` |
| name | 原生 checkbox 的 name 属性 | `string` | — |
| id | 原生 checkbox 的 id 属性 | `string` | — |
...
| 事件名 | 说明 | 回调参数 |
| --- | --- | --- |
| update:modelValue | 绑定值变化时触发，用于 `v-model` | `(value: boolean \| string \| number)` |
